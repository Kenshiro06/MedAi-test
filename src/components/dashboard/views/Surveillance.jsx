                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                            <thead style={{ background: 'rgba(255,255,255,0.02)' }}>
                                <tr>
                                    ...
                                    <th style={{ padding: '1rem', color: 'var(--color-text-muted)', fontWeight: '600', fontSize: '0.875rem' }}>Result</th>
                            ...
                            <tbody>
                                {surveillanceData.recentApproved.map((report, i) => (
                                    <tr key={i} style={{ borderBottom: '1px solid var(--color-glass-border)' }}>
                                        ...
                                        <td style={{ padding: '1rem' }}>
                                            <span style={{ padding: '0.25rem 0.75rem', borderRadius: '99px', background: report.result?.toLowerCase().includes('positive') ? 'rgba(255, 0, 85, 0.1)' : 'rgba(0, 255, 136, 0.1)', color: report.result?.toLowerCase().includes('positive') ? '#ff0055' : '#00ff88', fontSize: '0.875rem' }}>
                                                {report.result}
                                            </span>
                                        </td>
                                        <td style={{ padding: '1rem' }}>
